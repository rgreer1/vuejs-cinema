<template>
    <div id="day-select">
        <ul class="days">
            <!-- assign css class of "day" always, but assign class of "active" only if day is current -->
...
<script>
    export default {
        ...
        methods:{
            ...
            changeDay(change){
                let newDay = this.$moment(this.selected.add(change, 'days')); //for some reason we need to create a new instance of moment for the mutated date!?!?!
